...
from pylab import *     # Går inn i pylab-biblioteket og henter ut alt
import math             # Importerer math (matte) sånn at man kan ha f.eks. 7 som grunntall (oppg. c)
...
print("a) log2 7 =", log2(7))                       # a) log2 7 = 2.807354922057604
...
print("a) log2 7 =", round(log2(7), 2))             # a) log2 7 = 2.81
